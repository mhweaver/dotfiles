 ...
 */
char font[] = "DejaVu Sans Mono for Powerline:pixelsize=13:antialias=true:autohint=true";
int borderpx = 2;
 ...
 */
unsigned int defaultfg = 256; /* Was 12 */
...
Shortcut shortcuts[] = {
	...
	{ ShiftMask,            XK_Insert,      selpaste,       {.f =  0} },
	{ MODKEY|ShiftMask,     XK_Insert,      clippaste,      {.f =  0} },
